 ...
 * exactly like [Staleness.Current]: it is silent by design. The tiles are a
 * projection of the same presentation the situation was classified from
 * (`DashboardCache.state`), so they can never lag behind it.
 */
