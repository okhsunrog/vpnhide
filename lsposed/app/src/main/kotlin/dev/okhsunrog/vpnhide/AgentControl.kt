...
private fun parseNativeHookFamily(value: String): NativeHookFamily =
...
private fun parseAgentPortPolicy(
    mode: String,
    preset: String?,
...
private fun parseAgentPortPolicyResult(
    mode: String,
    preset: String?,
    rules: List<AgentPortRule>,
): Result<PortPolicy?> {
